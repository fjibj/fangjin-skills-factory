...
> **Brain First. AI Second. Brain Last.** — 用5个脑内Prompt系统化激活自己的思考能力，避免"先问AI再想"的思维偷懒惯性。

**核心哲学：**
- 人既是起点也是终点，AI 是中间的辅助
- 先自己写粗糙想法 → 再让AI做Companion反馈 → 最后自己独立合成验证

**5步流程 + Final Test：**

| 步骤 | 做什么 | 完成标准 |
|------|--------|---------|
| Step 1: "我已经知道什么？" | 自己在纸上写10分钟 | 有一份粗糙但真实的笔记 |
| Step 2: "什么假设可能是错的？" | 找出自己的隐形假设，尝试反转 | 至少推翻一个深信不疑的假设 |
| Step 3: "给我十个坏主意" | 绕过完美过滤器，写10条 | 写满了10条，发现里面的金子 |
| Step 4: "双向盲区对比" | 我看到了什么AI没看到？AI看到了什么我没看到？ | 有两列对比的盲区清单 |
| Step 5: "锁定洞察" | 一句话提炼核心洞察，制定记忆行动 | 用自己的话说清楚，且有具体行动 |
| Final Test | **关闭AI，独立解释** | 不用AI也能讲清楚 = 真正理解 |
...
**详细文档：** [SKILL.md](brain-first/SKILL.md)
